...
public class CardModel {
    ...
    public CardModel(String name, String price, String imageUrl, String urlLeft, String urlRight, String urlSide) {
        this.name = name;
        this.price = price;
    ...
    public CardModel(String name, String price, int imageUrl, int urlLeft, int urlRight, int urlSide) {
        this.name = name;
        this.price = price;
