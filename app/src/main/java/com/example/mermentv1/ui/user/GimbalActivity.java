...
public class GimbalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gimbal); // Create this layout file
    ...
    private void fetchProducts() {
        ...
        call.enqueue(new Callback<ProductResponse>() {
            ...
            public void onResponse(Call<ProductResponse> call, Response<ProductResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (productItems != null && !productItems.isEmpty()) {
                        ...
                        Toast.makeText(GimbalActivity.this, "No products available", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            ...
            public void onFailure(Call<ProductResponse> call, Throwable t) {
                ...
                Toast.makeText(GimbalActivity.this, "Failed to retrieve products", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void updateCardList(List<ProductItem> productItems) {
        if (productItems != null && !productItems.isEmpty()) {
            ...
            for (ProductItem productItem : productItems) {
                if ("gimbal".equalsIgnoreCase(productItem.getProductType())) {
